...
/**
 * BorderGlow — Mouse-tracking edge glow component from React Bits.
 * Adapted for Proct's Cyber-Minimalism design system.
 */
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  return (
    <div
      ...
      className={`relative grid isolate w-full h-full border border-[var(--border-subtle)] ${className}`}
      style={{
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          maskImage: 'radial-gradient(circle at top left, black 0%, transparent 35%)',
          WebkitMaskImage: 'radial-gradient(circle at top left, black 0%, transparent 35%)',
      ...
      >
        <span
          ...
          style={{
            inset: `${glowRadius}px`,
            boxShadow: buildBoxShadow(glowColor, glowIntensity * 0.6),
          }}
        />
      </span>
